...
- Wrap the framework boundary with [Wrap Tool Calls](/integrate-frameworks/wrap-tool-calls) or [Wrap LLM Calls](/integrate-frameworks/wrap-llm-calls).
...
- Use the typed value codec examples in [Using Codecs](/integrate-frameworks/using-codecs#typed-value-codecs) for structured conversion helpers.
