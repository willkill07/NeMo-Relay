...
and [Preferred Integration Order](/integrate-frameworks/code-examples#preferred-integration-order).
...
and [Wrap LLM Calls](/integrate-frameworks/wrap-llm-calls#streaming-providers).
...
storage. Refer to [Handle Non-Serializable Data](/integrate-frameworks/non-serializable-data).
...
Refer to [Exporter Selection](/plugins/observability/about#exporter-selection),
[OpenTelemetry](/plugins/observability/opentelemetry),
[OpenInference](/plugins/observability/openinference), and
...
Refer to [Adaptive](/plugins/adaptive/about),
...
Refer to [Using Codecs](/integrate-frameworks/using-codecs),
[Provider Codecs](/integrate-frameworks/provider-codecs), and
...
Refer to [Framework Integration Code Examples](/integrate-frameworks/code-examples#quickstart-apply-maintained-patches)
