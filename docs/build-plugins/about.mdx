...
- [NeMo Guardrails Example Plugin](/build-plugins/nemoguardrails) shows an external Python plugin that applies NeMo Guardrails checks around NeMo Relay LLM and tool calls.
