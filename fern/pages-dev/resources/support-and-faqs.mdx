...
documentation-visible release status. [GitHub Releases](https://github.com/NVIDIA/NeMo-Relay/releases)
contains the complete release history.
...
- Documentation changes: `just docs`; `just docs-linkcheck` is an equivalent
  compatibility entrypoint, not an additional check.
