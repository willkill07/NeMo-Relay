...
After Relay is attached to a framework, use
[Configure and Initialize Plugins](/configure-plugins/initialize-plugins) when
the application needs Relay to manage process-wide plugin behavior.
...
- [Configure and Initialize Plugins](/configure-plugins/initialize-plugins)
  explains plugin-host configuration, validation, diagnostics, and shutdown.
