...
If Relay should manage process-wide plugin behavior, such as an exporter or
policy component, use [Configure and Initialize Plugins](/configure-plugins/initialize-plugins).
...
- [Configure and Initialize Plugins](/configure-plugins/initialize-plugins)
  explains how to configure, validate, activate, and close process-wide plugins.
