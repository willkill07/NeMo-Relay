...
pricing source matches the response model and usage fields. For catalog setup
and embedded plugin examples, see
...
- If pricing is configured, LLM end events include
